...
class Database {
    private static $className = "Database";
    ...
    public function __construct($db = DB_DATA, $host = DB_HOST, $user = DB_USER, $pass = DB_PASS)
    {
    ...
    protected function _execStatement($stmt, $reset = true)
    {
        ...
        if ($success !== true) {
            ...
            $this->_stmtError = "{$errInfo[0]} PDO Error #{$errInfo[1]}: {$errInfo[2]}";
            $result = false;
        } else {
